...
Sphere sp = Sphere(0.75, 20, 20); //recibe radio, slices, stacks
...
int main()
{
	...
	*/
	...
	glm::mat4 modelaux3(1.0);//Inicializar matriz de Modelo 4x4
	glm::mat4 modelaux4(1.0);//Inicializar matriz de Modelo 4x4
	glm::mat4 modelaux5(1.0);//Inicializar matriz de Modelo 4x4
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//modelaux = model; //Matriz auxiliar para construir los brazos y articulaciones
		//modelaux1 = model; // Matriz auxiliar para construir la base y las llantas
		...
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		modelaux = model; //Matriz auxiliar para construir la cabeza
		modelaux1 = model; // Matriz auxiliar para construir la pata frontal derecha
		modelaux2 = model; // Matriz auxiliar para construir la pata frontal izquierda
		modelaux3 = model; // Matriz auxiliar para construir la pata trasera derecha
		modelaux4 = model; // Matriz auxiliar para construir la pata trasera izquierda
		modelaux5 = model; // Matriz auxiliar para construir la cola
		...
		//ARTICULACION 1 CUERPO-MUSLO DERECHA FRONTAL
		model = modelaux1;
		...
		//MUSLO
		//rotación alrededor de la articulación que une con el cuerpo
		model = glm::translate(model, glm::vec3(0.0f, -1.25f, 0.0f));
		modelaux1 = model;
		model = glm::scale(model, glm::vec3(0.9f, 2.5f, 0.9f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 0.5f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[2]->RenderMeshGeometry(); 

		//ARTICULACION 2 MUSLO-PATA DERECHA FRONTAL
		model = modelaux1;
		model = glm::translate(model, glm::vec3(0.0f, -1.25f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//PATA
		//rotación alrededor de la articulación que une con el muslo
		model = glm::translate(model, glm::vec3(0.0f, -1.25f, 0.0f));
		modelaux1 = model;
		model = glm::scale(model, glm::vec3(0.9f, 2.5f, 0.9f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//ARTICULACION 3 CUERPO-MUSLO IZQUIERDA FRONTAL
		model = modelaux2;
		model = glm::translate(model, glm::vec3(-1.25f, -1.5f, 1.25f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion3()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//ARTICULACION 4 MUSLO-PATA IZQUIERDA FRONTAL
		model = modelaux2;
		model = glm::translate(model, glm::vec3(0.0f, -1.25f, 0.0f));
		...
		//ARTICULACION 5 CUERPO-MUSLO IZQUIERDA FRONTAL
		model = modelaux3;
		model = glm::translate(model, glm::vec3(1.25f, -1.5f, -1.25f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//ARTICULACION 6 MUSLO-PATA IZQUIERDA FRONTAL
		model = modelaux3;
		model = glm::translate(model, glm::vec3(0.0f, -1.25f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion6()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//ARTICULACION 7 CUERPO-MUSLO IZQUIERDA FRONTAL
		model = modelaux4;
		model = glm::translate(model, glm::vec3(1.25f, -1.5f, 1.25f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion7()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//ARTICULACION 8 MUSLO-PATA IZQUIERDA FRONTAL
		model = modelaux4;
		model = glm::translate(model, glm::vec3(0.0f, -1.25f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion8()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//CABEZA
		//ARTICULACION 9 CUERPO-CUELLO
		model = modelaux;
		model = glm::translate(model, glm::vec3(-2.5, 0.0f, 0.0f));
		...
		model = glm::translate(model, glm::vec3(0.0f, 2.5f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.9f, 5.0f, 0.9f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 0.5f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[2]->RenderMeshGeometry();

		//ARTICULACION 10 CUELLO-CABEZA
		model = modelaux;
		...
		//CABEZA
		//rotación alrededor de la articulación que une con el CUELLO
		model = glm::rotate(model, glm::radians(-45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(-2.0f, 1.25f, -1.0f));
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(2.0f, 2.0f, -1.75f));
		model = glm::rotate(model, glm::radians(15.0f), glm::vec3(-1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.5f, 6.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.5f, 0.5f, 0.5f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh();
