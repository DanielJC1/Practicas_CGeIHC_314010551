...
int main()
{
	...
	glm::mat4 modelaux(1.0);//Matriz auxiliar mandíbula
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 6.00f, -1.5f));
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.84f, 0.0f);
		...
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(1.0f, 0.0f, 0.0f)); // Rotar llantas
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
